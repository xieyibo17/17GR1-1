...
<div class="log_bg">	
	...
	<div class="login">
		...
		<div class="log_c">
        	...
        	<input type="hidden" name="pro" value="denglu">
            <table border="0" style="width:370px; font-size:14px; margin-top:30px;" cellspacing="0" cellpadding="0">
              ...
              <tr height="70">
                <td>用户名</td>
                <td><input type="text" value="" class="l_user" required="required" name="yhm"/></td>
              </tr>
              <tr height="70">
                <td>密&nbsp; &nbsp; 码</td>
                <td><input type="password" value="" class="l_pwd" required="required" name="mm"/></td>
              </tr>
              <tr>
              	<td>&nbsp;</td>
